...
public class JwtUtil {
    ...
    /** Normal access token issued after a successful login/register/OTP-login. */
    public String generateAccessToken(String subject, Long userId, String role) {
        Date now = new Date();
    ...
    /** Short-lived token proving the user just verified a "forgot password" OTP. */
